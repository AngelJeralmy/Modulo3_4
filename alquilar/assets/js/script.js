...
const departamentos_alquiler = [
  {src:'../index/assets/img/depa.jpg', descripcion: 'Hubicado en pleno centro ', ubicacion: 'Lira 254', habitaciones: 2, costo: 350000, smoke: false, pets: true },
  {src:'../index/assets/img/depa.jpg', descripcion: 'Cerca de metro sta. lucía', ubicacion: 'San isidro 435', habitaciones: 1, costo: 200000, smoke: false, pets: true },
  {src:'../index/assets/img/depa.jpg', descripcion: ' Una experiencia unica', ubicacion: ' Portugal 231', habitaciones: 3, costo: 400000, smoke: true, pets: false },
  {src:'../index/assets/img/depa.jpg', descripcion: 'Un dpto. con lineas de mujer', ubicacion: 'Marcoleta 254', habitaciones: 1, costo: 250000, smoke: false, pets: false },
  {src:'../index/assets/img/depa.jpg', descripcion: 'Una experiencia unica', ubicacion: 'Lira 320', habitaciones: 2, costo: 320000, smoke: false, pets: true },
  {src:'../index/assets/img/depa.jpg', descripcion: 'Todo lo que podras soñar', ubicacion: 'Carmen 370', habitaciones: 3, costo: 410000, smoke: false, pets: false }
]
