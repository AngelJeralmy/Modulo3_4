...
const departamentos_venta = [
  {src:'../index/assets/img/depa.jpg', descripcion: 'Es tu mejor oprtunidad', ubicacion: 'Lira 300', habitaciones: 2, costo: 370000, smoke: true, pets: false },
  {src:'../index/assets/img/depa.jpg', descripcion: 'Fresco, soleado y carismatico', ubicacion: 'Luz 2343', habitaciones: 1, costo: 206000, smoke: false, pets: true },
  {src:'../index/assets/img/depa.jpg', descripcion: ' Una experiencia sin igual', ubicacion: 'Santa isabel 200', habitaciones: 3, costo: 500000, smoke: true, pets: false },
  {src:'../index/assets/img/depa.jpg', descripcion: 'Un dpto. con lineas personales', ubicacion: 'Portugal 550', habitaciones: 1, costo: 250000, smoke: false, pets: false },
  {src:'../index/assets/img/depa.jpg', descripcion: 'Un sin igual de emociones', ubicacion: 'Oxford 120', habitaciones: 2, costo: 310000, smoke: false, pets: true },
  {src:'../index/assets/img/depa.jpg', descripcion: 'Ven, atrevete a conocerlo', ubicacion: 'Maracaibo 1200', habitaciones: 3, costo: 420000, smoke: false, pets: false }
]
